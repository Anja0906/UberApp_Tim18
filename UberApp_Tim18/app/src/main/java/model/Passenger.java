...
public class Passenger extends User{
    ...
    public Passenger(Integer id, String name, String surname, String profilePicture, String telephoneNumber, String email, String address, String password, boolean blocked, boolean active, String verificationCode, String resetPasswordToken, String timeOfResetPasswordToken, List<String> roles, List<FavouriteRoute> favouriteRoutes) {
